...
public class method_StringClass {
	public static void main(String[] args) {
		...
		System.out.println(str.charAt(3));//character at index
		...
		System.out.println(str.substring(5));//sub-string from index
		System.out.println(str.substring(5,9));//sub-string from index, to index
